...
const copy = {
  "pt-PT": { loading: "A carregar o seu perfil…", loadError: "Não foi possível carregar o seu perfil.", retry: "Tentar novamente", name: "Nome", email: "Email", verified: "Email verificado", unverified: "Email ainda não verificado", save: "Guardar alterações", saving: "A guardar…", saved: "Perfil atualizado.", saveError: "Não foi possível atualizar o perfil.", required: "Indique o seu nome.", emailHint: "A alteração de email será disponibilizada numa área de segurança própria.", avatarAlt: "Avatar do utilizador" },
  "pt-BR": { loading: "Carregando seu perfil…", loadError: "Não foi possível carregar seu perfil.", retry: "Tentar novamente", name: "Nome", email: "Email", verified: "Email verificado", unverified: "Email ainda não verificado", save: "Salvar alterações", saving: "Salvando…", saved: "Perfil atualizado.", saveError: "Não foi possível atualizar o perfil.", required: "Informe seu nome.", emailHint: "A alteração de email será disponibilizada em uma área de segurança própria.", avatarAlt: "Avatar do usuário" },
  en: { loading: "Loading your profile…", loadError: "We couldn't load your profile.", retry: "Try again", name: "Name", email: "Email", verified: "Email verified", unverified: "Email not verified yet", save: "Save changes", saving: "Saving…", saved: "Profile updated.", saveError: "We couldn't update the profile.", required: "Enter your name.", emailHint: "Email changes will be available in a dedicated security area.", avatarAlt: "User avatar" },
  es: { loading: "Cargando tu perfil…", loadError: "No se pudo cargar tu perfil.", retry: "Intentar de nuevo", name: "Nombre", email: "Email", verified: "Email verificado", unverified: "Email aún no verificado", save: "Guardar cambios", saving: "Guardando…", saved: "Perfil actualizado.", saveError: "No se pudo actualizar el perfil.", required: "Indica tu nombre.", emailHint: "El cambio de email estará disponible en un área de seguridad específica.", avatarAlt: "Avatar del usuario" },
} as const;
...
export function AccountProfile({ locale }: { locale: SupportedLocale }) {
  ...
  async function saveProfile() {
    if (!normalizedName) { setValidationError(c.required); return; }
