...
const copy = {
  "pt-PT": { loading: "A verificar sessão…", unavailable: "Não foi possível verificar a sessão. Atualize a página para tentar novamente.", dashboard: "Painel", reservations: "Reservas", menu: "Menu", events: "Eventos", customers: "Clientes", team: "Equipa", profile: "Perfil", settings: "Operação", logout: "Sair" },
  "pt-BR": { loading: "Verificando sessão…", unavailable: "Não foi possível verificar a sessão. Atualize a página para tentar novamente.", dashboard: "Painel", reservations: "Reservas", menu: "Cardápio", events: "Eventos", customers: "Clientes", team: "Equipe", profile: "Perfil", settings: "Operação", logout: "Sair" },
  en: { loading: "Checking session…", unavailable: "We couldn't verify the session. Refresh the page to try again.", dashboard: "Dashboard", reservations: "Reservations", menu: "Menu", events: "Events", customers: "Customers", team: "Team", profile: "Profile", settings: "Operations", logout: "Sign out" },
  es: { loading: "Verificando la sesión…", unavailable: "No se pudo verificar la sesión. Actualiza la página para intentarlo de nuevo.", dashboard: "Panel", reservations: "Reservas", menu: "Menú", events: "Eventos", customers: "Clientes", team: "Equipo", profile: "Perfil", settings: "Operación", logout: "Salir" },
