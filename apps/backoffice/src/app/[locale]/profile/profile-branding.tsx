...
const copy = {
  "pt-PT": {
    publicSection: "Perfil público", publicHelp: "Estes dados alimentam o site público e os futuros canais do Mandy's.", publicName: "Nome público", legalName: "Nome legal", description: "Descrição", contactEmail: "Email de contacto", contactPhone: "Telefone de contacto", bookingDuration: "Duração padrão da reserva (min)", brand: "Identidade visual", brandHelp: "Use URLs HTTPS por agora. O carregamento direto de imagens será ligado ao armazenamento posteriormente.", logo: "URL do logótipo", cover: "URL da imagem de capa", location: "Localização principal", locationName: "Nome da localização", locationEmail: "Email da localização", locationPhone: "Telefone da localização", address1: "Morada", address2: "Complemento", postalCode: "Código postal", city: "Cidade", country: "País", save: "Guardar alterações", saving: "A guardar…", loading: "A carregar perfil…", saved: "Perfil atualizado.", retry: "Atualizar", genericError: "Não foi possível concluir a operação.", preview: "Pré-visualização", previewHelp: "Uma referência rápida da marca que será usada no storefront.", noImage: "Sem imagem de capa",
  },
  "pt-BR": {
    publicSection: "Perfil público", publicHelp: "Estes dados alimentam o site público e os futuros canais do Mandy's.", publicName: "Nome público", legalName: "Nome legal", description: "Descrição", contactEmail: "E-mail de contato", contactPhone: "Telefone de contato", bookingDuration: "Duração padrão da reserva (min)", brand: "Identidade visual", brandHelp: "Use URLs HTTPS por enquanto. O envio direto de imagens será conectado ao armazenamento depois.", logo: "URL do logotipo", cover: "URL da imagem de capa", location: "Unidade principal", locationName: "Nome da unidade", locationEmail: "E-mail da unidade", locationPhone: "Telefone da unidade", address1: "Endereço", address2: "Complemento", postalCode: "CEP / código postal", city: "Cidade", country: "País", save: "Salvar alterações", saving: "Salvando…", loading: "Carregando perfil…", saved: "Perfil atualizado.", retry: "Atualizar", genericError: "Não foi possível concluir a operação.", preview: "Pré-visualização", previewHelp: "Uma referência rápida da marca que será usada no storefront.", noImage: "Sem imagem de capa",
  },
  en: {
    publicSection: "Public profile", publicHelp: "These details feed the public site and future Mandy's channels.", publicName: "Public name", legalName: "Legal name", description: "Description", contactEmail: "Contact email", contactPhone: "Contact phone", bookingDuration: "Default reservation duration (min)", brand: "Brand identity", brandHelp: "Use HTTPS URLs for now. Direct image upload will be connected to storage later.", logo: "Logo URL", cover: "Cover image URL", location: "Primary location", locationName: "Location name", locationEmail: "Location email", locationPhone: "Location phone", address1: "Address", address2: "Address line 2", postalCode: "Postal code", city: "City", country: "Country", save: "Save changes", saving: "Saving…", loading: "Loading profile…", saved: "Profile updated.", retry: "Refresh", genericError: "The operation could not be completed.", preview: "Preview", previewHelp: "A quick reference of the brand that will be used by the storefront.", noImage: "No cover image",
  },
  es: {
    publicSection: "Perfil público", publicHelp: "Estos datos alimentan la web pública y los futuros canales de Mandy's.", publicName: "Nombre público", legalName: "Nombre legal", description: "Descripción", contactEmail: "Email de contacto", contactPhone: "Teléfono de contacto", bookingDuration: "Duración estándar de la reserva (min)", brand: "Identidad visual", brandHelp: "Usa URLs HTTPS por ahora. La carga directa de imágenes se conectará al almacenamiento después.", logo: "URL del logotipo", cover: "URL de la imagen de portada", location: "Ubicación principal", locationName: "Nombre de la ubicación", locationEmail: "Email de la ubicación", locationPhone: "Teléfono de la ubicación", address1: "Dirección", address2: "Complemento", postalCode: "Código postal", city: "Ciudad", country: "País", save: "Guardar cambios", saving: "Guardando…", loading: "Cargando perfil…", saved: "Perfil actualizado.", retry: "Actualizar", genericError: "No se pudo completar la operación.", preview: "Vista previa", previewHelp: "Una referencia rápida de la marca que utilizará el storefront.", noImage: "Sin imagen de portada",
  },
    ...
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
      <div className="space-y-6">
        ...
        <section className="rounded-[var(--mandys-radius-lg)] border border-[var(--mandys-border)] bg-[var(--mandys-surface)] p-5 shadow-[var(--mandys-shadow-sm)]">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2">
            <label className="text-sm font-medium">{c.logo}<input type="url" placeholder="https://…" className={field} value={form.logoUrl} onChange={(e) => set("logoUrl", e.target.value)} /></label>
            <label className="text-sm font-medium">{c.cover}<input type="url" placeholder="https://…" className={field} value={form.coverUrl} onChange={(e) => set("coverUrl", e.target.value)} /></label>
          </div>
        </section>
