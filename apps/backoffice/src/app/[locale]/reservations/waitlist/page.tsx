...
const copy = {
  "pt-PT": { back: "Voltar às reservas", title: "Lista de espera" },
  "pt-BR": { back: "Voltar às reservas", title: "Lista de espera" },
  en: { back: "Back to bookings", title: "Waitlist" },
  es: { back: "Volver a reservas", title: "Lista de espera" },
} as const;

export default async function ReservationWaitlistPage({ params }: { params: Promise<{ locale: string }> }) {
