...
values
  ...
  ('start','IN','INR',99900,999000,5,9900,false),
  ('grow','IN','INR',179900,1799000,15,9900,false),
  ('operate','IN','INR',299900,2999000,30,9900,false),
  ('intelligence','IN','INR',449900,4499000,30,9900,false),
  ('multi','IN','INR',699900,6999000,50,9900,false),
